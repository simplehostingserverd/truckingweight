...
export default function LoadStatusUpdater({ loadId, currentStatus, onStatusUpdate }: LoadStatusUpdaterProps) {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
      ...
      <form className="p-6 space-y-4" onSubmit={handleSubmit}>
        ...
        {(status === 'In Transit' || status === 'Delivered') && (
          <div>
            <label htmlFor="actualDeparture" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              Actual Departure
            </label>
            <input
              id="actualDeparture"
        ...
        {status === 'Delivered' && (
          <div>
            <label htmlFor="actualArrival" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              Actual Arrival
            </label>
            <input
              id="actualArrival"
