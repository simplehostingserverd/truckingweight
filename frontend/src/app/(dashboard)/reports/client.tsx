        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{nonCompliantCount}</p>
            </div>
          </div>
        </div>
      </div>
            ...
            {[
              {
                ...
                description: "Detailed analysis of weight measurements and compliance status across your fleet.",
                link: "/reports/weight-compliance"
              },
              {
                title: "Vehicle Performance Report",
                description: "Analysis of vehicle usage, maintenance status, and weight distribution.",
                link: "/reports/vehicle-performance"
              },
              {
                title: "Driver Activity Report",
                description: "Summary of driver assignments, loads completed, and compliance records.",
              ...
              },
              {
                ...
                description: "Overview of load statuses, delivery performance, and route efficiency.",
