        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button className="flex justify-center items-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white">
