...
/**
 * Simple Scale Solutions Type Definitions
 * This file contains TypeScript interfaces for the Simple Scale Solutions database schema
 */
...
export interface LoadOptimization {
  id: number;
  weigh_ticket_id: number;
  original_distribution: unknown; // JSON
  suggested_distribution: unknown; // JSON
