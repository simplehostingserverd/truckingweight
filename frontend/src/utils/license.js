...
import { getAppVersion, generateSessionId } from './watermark';
...
export async function verifyLicense() {
  try {
    ...
    if (!response.ok) {
      ...
      console.error('License verification failed:', errorData);
      
      if (errorData.error === 'License has been revoked' || errorData.error === 'License has expired') {
        activateKillSwitch(errorData.error);
      }
