...
export class ErpService {
   ...
   */
  async fetchCustomers(connectionId: string): Promise<): Promise<): Promise<): Promise<): ): ): Promise<ErpData[] | null> => {> {> { {> { {> {
    try {
   ...
   */
  async fetchInvoices(connectionId: string, customerId?: string): Promise<): Promise<): Promise<): Promise<): ): ): Promise<ErpData[] | null> => {> {> { {> { {> {
    try {
      // Get the integration connection
      const connection = await prisma.integration_connections.findUnique({
        where: { id: connectionId },
   ...
   */
  async createInvoice(connectionId: string, invoiceData: any): Promise<): Promise<): Promise<): Promise<): ): ): Promise<ErpData | null> => {> {> { {> { {> {
    try {
      // Get the integration connection
      const connection = await prisma.integration_connections.findUnique({
        where: { id: connectionId },
   ...
   */
  async syncWeighTicket(connectionId: string, ticketId: string): Promise<): Promise<): Promise<): Promise<): ): ): Promise<ErpData | null> => {> {> { {> { {> {
    try {
      // Get the integration connection
      const connection = await prisma.integration_connections.findUnique({
        where: { id: connectionId },
